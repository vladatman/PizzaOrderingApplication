...
public class GetPizzaByIdWithDefaultToppingsHandler : IRequestHandler<GetPizzaByIdWithDefaultToppingsQuery, PizzaDto>
{
    private readonly IPizzaRepository _pizzaRepository;
    
    public GetPizzaByIdWithDefaultToppingsHandler(IPizzaRepository pizzaRepository)
    {
        _pizzaRepository = pizzaRepository;
    }
    
    public async Task<PizzaDto> Handle(GetPizzaByIdWithDefaultToppingsQuery request, CancellationToken cancellationToken)
    {
